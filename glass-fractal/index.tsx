...
export function GlassFractalShowcase({ className = "" }: { className?: string }) {
  ...
  return (
    <div
      className={`relative h-full w-full overflow-hidden rounded-2xl border border-slate-700/60 shadow-2xl min-h-[550px] ${className}`}
      style={{
        background:
          "radial-gradient(ellipse at 95% 0%, #1a2a3a 0%, #122233 45%, #0B1522 78%)",
      }}
    >
      <canvas
        ref={canvasRef}
...
export default GlassFractalShowcase;
